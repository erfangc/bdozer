...
export function DownloadToExcel({ stockAnalysis, className, ...props }: DownloadToExcelProps) {
    ...
    return (
        <button
            className={`hover:bg-emerald-500 hover:text-white text-emerald-500 hidden md:flex transition ease-in px-4 py-1 rounded border border-emerald-600 block items-center focus:outline-none w-full ${className}`}
            disabled={loading}
