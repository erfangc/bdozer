...
export function AlreadyResearching() {
    return (
        <section className="bg-lime-75 px-8 lg:px-0 py-16 flex flex-col items-center space-y-6">
            <h3 className="heading3">Already Researching? See an Analysis.</h3>
            <p className="hidden lg:block paragraph-regular text-center">
                Search a company to see our analysis and determine<br/>
                whether or not to invest.
            </p>
            <p className="lg:hidden paragraph-regular text-center">
