...
function DownloadToExcel(props: { onClick: () => void }) {
    return (
        <button
            ...
            className="focus:outline-none hidden md:flex items-center text-sm px-2 py-1.5 rounded border border-emerald-700 text-emerald-500 transition ease-linear hover:bg-emerald-500 hover:text-emerald-50 w-full"
        >
