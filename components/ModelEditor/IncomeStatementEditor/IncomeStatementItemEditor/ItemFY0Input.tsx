...
import { useMxParserApi } from "../../../../ApiClientsHooks";
    ...
    return (
        <div className="flex-col flex">
            ...
            <div className="relative flex">
                ...
                <button className="transition ease-linear hover:bg-blueGray-700 rounded px-2 ml-1 focus:outline-none" onClick={attemptSubmit}>
