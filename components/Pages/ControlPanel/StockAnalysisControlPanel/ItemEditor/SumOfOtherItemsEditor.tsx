...
export function SumOfOtherItemsEditor({ item, onSubmit }: Props) {
    ...
    function updateComponentName(oldValue: string, newValue: string) {
        ...
        onSubmit({ ...item, type: ItemTypeEnum.SumOfOtherItems, sumOfOtherItems: { ...sumOfOtherItems, components: updatedComponent } })
    }
    ...
    function add() {
        const updatedComponent: Component[] = [...sumOfOtherItems.components, { itemName: 'NewItemPleaseRename', weight: 1 }]
        setSumOfOtherItems({ ...sumOfOtherItems, components: updatedComponent })
        onSubmit({ ...item, type: ItemTypeEnum.SumOfOtherItems, sumOfOtherItems: { ...sumOfOtherItems, components: updatedComponent } })
    }
