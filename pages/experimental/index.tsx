...
function Experimental() {
    ...
    return (
        <main className="min-h-screen flex bg-blueGray-900 justify-center text-blueGray-50 px-2 pt-10 items-start xl:items-center xl:px-0 xl:pt-0">
            <div className="relative container max-w-lg">
                <div className={`bg-blueGray-700 p-4 ${entities.length > 0 ? 'rounded-t-lg' : 'rounded-lg'}`}>
                    ...
                    <input
                        ...
                        className="relative text-blueGray-50 px-3 py-2 focus:outline-none bg-blueGray-700 placeholder-blueGray-400 text-lg"
                    />
                </div>
