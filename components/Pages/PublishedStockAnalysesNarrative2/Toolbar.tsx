...
export function Toolbar({stockAnalysis}: Props) {

    return (
        <div className="shadow bg-blueGray-800 px-2 py-2 flex space-x-6 fixed bottom-0 left-0 right-0 justify-center z-10 overflow-x-scroll lg:hidden">
            ...
            <ToolButton href={`/control-panel/stock-analyses/${stockAnalysis['_id']}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
