...
export function TocScrollspy({stockAnalysis}: Props) {
    ...
    return (
        <nav className="hidden lg:block fixed top-12 w-64 right-0 py-4 text-blueGray-200 z-10 bg-blueGray-800 shadow-md rounded text-sm">
            <Scrollspy
            ...
            <div className="border-t border-blueGray-500 pt-4 mt-4">
                <Link href={`/control-panel/stock-analyses/${stockAnalysis['_id']}`}>
                    <a className="hover:bg-blue-500 transition ease-in px-4 py-1 rounded border mx-2 border-blueGray-600 block flex justify-center items-center">
